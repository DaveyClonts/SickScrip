...
/* Sic GRAMMAR (lowest to highest precedence)
--------------------------------------------------------------
...
class Parser {
    ...
    private Stmt classDeclaration() {
        ...
        while (!check(RIGHT_BRACE) && !isAtEnd()) {
            ...
            consume(FUN, "Expect 'FUnKYY' before method name.");
    ...
    /**
     * BNF: exprStmt | forStmt | ifStmt | printStmt | returnStmt | whileStmt |
     * block
     *
     * @return
     */
